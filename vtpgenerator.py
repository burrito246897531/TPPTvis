...
#ge68_line_source = vg.generate_cylinder_mesh(0, 0, 0, 2, 100, direction=(0, 0, 1), resolution=64, color = [255, 0, 0])
...
castor_mesh = vg.castor_mesh(file_name + '.img', file_name + '.hdr', prop = 0.0002, trim = 55)
vg.save_mesh_as_vtp(castor_mesh, file_name + 'derenzo.vtp')